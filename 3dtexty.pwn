...
Zaladuj3DTexty()
{
	...
	okienko[0] = CreateDynamic3DTextLabel("Urz¹d Miasta Los Santos\n{0080FF}Okienko 1 \n {FF0000}[Wpisz /kuplicencje]",COLOR_WHITE,1454.55847, -1792.14673, 79.56396,9,INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 50, 0);
	okienko[1] = CreateDynamic3DTextLabel("Urz¹d Miasta Los Santos\n{0080FF}Okienko 2 \n {FF0000}[Wpisz /kuplicencje]",COLOR_WHITE,1454.59851, -1795.38660, 79.56400,9,INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 50, 0);
	okienko[2] = CreateDynamic3DTextLabel("Urz¹d Miasta Los Santos\n{0080FF}Okienko 3 \n {FF0000}[Wpisz /kuplicencje]",COLOR_WHITE,1454.59851, -1798.56665, 79.56400,9,INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 50, 0);
	okienko[3] = CreateDynamic3DTextLabel("Urz¹d Miasta Los Santos\n{0080FF}Okienko 4 \n {FF0000}[Wpisz /kuplicencje]",COLOR_WHITE,1454.59814, -1801.72668, 79.56400,9,INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 50, 0);
	okienko[4] = CreateDynamic3DTextLabel("Urz¹d Miasta Los Santos\n{0080FF}Okienko 5 \n {FF0000}[Wpisz /kuplicencje]",COLOR_WHITE,1446.32007, -1791.37695, 79.56400,9,INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 50, 0);
	...
	okienko[15] = CreateDynamic3DTextLabel("Urz¹d Miasta Palomino Creek\n{0080FF}Okienko 1\n{FF0000}[Wpisz /kuplicencje]", COLOR_WHITE, 2314.6875,-84.4130,41.5881, 9, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 1, 0);
	okienko[16] = CreateDynamic3DTextLabel("Urz¹d Miasta Palomino Creek\n{0080FF}Okienko 2\n{FF0000}[Wpisz /kuplicencje]", COLOR_WHITE, 2314.6875,-80.2383,41.5881, 9, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 1, 0);
    ...
    CreateDynamic3DTextLabel("Wyjœcie z toru", COLOR_NEWS, -433.55599975586,-3812.8073730469,176.7035064697, 10.0);
	...
	new str2[512];
    str2 = "{FFA500}Dowód osobisty - {9ACD32}5000$ +akt urodz.\n{FFA500}Wydanie Prawa Jazdy - {9ACD32}5 000$ +zal. egz.\n {FFA500}Patent ¯eglarski - {9ACD32}100 000$\n {FFA500}Pozwolenie na bron - {9ACD32}50 000$\n {FFA500}Licencja Pilota - {9ACD32}500 000$\n {FFA500}Karta wêdkarska - {9ACD32}10 000$\n{9ACD32}Egzamin teoretyczny - 5 000${FFA500}\n{9ACD32}Egzamin praktyczny- {9ACD32} 7 500$";
	...
	CreateDynamic3DTextLabel(str2, COLOR_NEWS, 378.6695,178.0520,1010.1828,12,INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 7110, 3);//Cennik DMV VC
	CreateDynamic3DTextLabel(str2, COLOR_NEWS, 2321.0730, -78.1003, 40.5000, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 1);//Cennik DMV PC
	...
	CreateDynamic3DTextLabel("Przejœcie s³u¿bowe", COLOR_GREEN, 1063.2349,1063.8685,-15.6441, 8.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 50);//36
	...
	CreateDynamic3DTextLabel("Przejœcie s³u¿bowe", COLOR_GREEN, 1088.3507,1089.1888,-15.6441, 8.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 50);//36
	...
	CreateDynamic3DTextLabel("Biuro Urzêdników", COLOR_GREEN, 1485.7014,-1775.9730,164.3959, 8.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 60);//36
	...
	CreateDynamic3DTextLabel("Adwokatura, Prokuratura\nGabinety Sêdziów", COLOR_GREEN, -1778.8135,528.1346,-18.9341, 8.0,INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 75);//36

	CreateDynamic3DTextLabel("Aby rozpocz¹æ zakupy wpisz /kupdildo", 0xFF00FFAA, -105.0829,-10.6207,1000.7188, 5.0);
...
//	CreateDynamic3DTextLabel("{FF00FF}V{FFFFFF}inyl {FF00FF}C{FFFFFF}lub", COLOR_BLUE, 816.0999,-1386.8,13.6, 10.0);//VIP VINYL club central
	...
	// Vice City
	CreateDynamic3DTextLabel("Salon Aut\n/kupauto", COLOR_BLUE, -5234.5198, 1403.6206,7.5452, 15.0);
	CreateDynamic3DTextLabel("Sklep Motocyklowy\n/kupmotor", COLOR_BLUE, -4802.0796, 2921.8924,5.5407, 15.0);
	CreateDynamic3DTextLabel("Stocznia Ocean Beach\n/kuplodz", COLOR_BLUE, -4430.3613, 949.4258,3.5730, 15.0);
	CreateDynamic3DTextLabel("Stocznia Vice City\n/kuplodz", COLOR_BLUE, -4841.2861, 764.7393,8.2627, 15.0);
	CreateDynamic3DTextLabel("Fabryka pojazdów lataj¹cych\n/kupsamolot\n/kuphelikopter", COLOR_BLUE, -5885.2761, 1316.9617,9.3252, 15.0);
