...
ZaladujIkony()
{
    ...
    // Vice City
    MruCreateDynamicMapIcon(-4430.3613, 949.4258, 3.5730, 9, 1, -1, -1, -1, streamDist, iconType);//<B3>odzie Vice City Ocean Beach
    MruCreateDynamicMapIcon(-4841.2861, 764.7393, 8.2627, 9, 1, -1, -1, -1, streamDist, iconType);//<B3>odzie Vice City Doki
